...
function preload(){
    //loadImages
    flappyImg = loadImage("/assets/dino.png");
    //baixo
...
function criarObstaculos(){
    var randomvar = Math.round(random(windowHeight*3/2,windowHeight*3/1.8));

    if(score%75 === 0){
        var obstacle2 = createSprite(windowWidth+10,randomvar,50,windowHeight);
